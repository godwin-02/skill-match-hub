      ...
      <BrowserRouter>
        <AuthProvider>
          <Routes>
            ...
            <Route path="/u/:userId" element={<PublicStudentProfile />} />
            <Route path="/c/:userId" element={<PublicCompanyProfile />} />
            ...
            {/* Messages (student + company + admin) */}
            <Route path="/messages" element={<ProtectedRoute><Messages /></ProtectedRoute>} />
            <Route path="/messages/:applicationId" element={<ProtectedRoute><Messages /></ProtectedRoute>} />
